package com.habit.reboot.backend.filter;

import com.habit.reboot.backend.models.SimpleUser;
import com.habit.reboot.backend.services.HabitRebootUserDetailsService;
import com.habit.reboot.backend.util.JwtUtil;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private final HabitRebootUserDetailsService userDetailsService;
